...
{
    return std::make_shared<OpenGLRenderer>(std::move(context));
}

OpenGLRenderer::OpenGLRenderer(std::shared_ptr<RendererContext> context)
...
std::shared_ptr<core::Mesh> OpenGLRenderer::createMesh()
{
