...
class MeshImpl final : public IMesh
{
public:

    MeshImpl(ResourceId id, const std::string& name);
    ...
    void SetVertexData(const VertexData& data) override;
    void AddSubMesh(const SubMesh& submesh) override;
