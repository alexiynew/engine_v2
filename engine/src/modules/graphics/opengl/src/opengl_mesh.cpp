...
GLenum ToGLType(game_engine::graphics::VertexAttributeType type)
{
    switch (type) {
        case game_engine::graphics::VertexAttributeType::Float: return GL_FLOAT;
        case game_engine::graphics::VertexAttributeType::Int:   return GL_INT;
        case game_engine::graphics::VertexAttributeType::UInt:  return GL_UNSIGNED_INT;
...
GLenum ToGLPrimitiveType(game_engine::graphics::PrimitiveType primitiveType)
{
    switch (primitiveType) {
        ...
        case game_engine::graphics::PrimitiveType::Lines:         return GL_LINES;
        case game_engine::graphics::PrimitiveType::LineStrip:     return GL_LINE_STRIP;
        case game_engine::graphics::PrimitiveType::LineLoop:      return GL_LINE_LOOP;
        case game_engine::graphics::PrimitiveType::Points:        return GL_POINTS;
